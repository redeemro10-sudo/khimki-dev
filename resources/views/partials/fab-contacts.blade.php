@php
    $links = [
        'wa' => 'https://wa.me/79879815874',
        'tg' => 'https://t.me/elllie_mng',
        'max' => 'https://max.ru/u/f9LHodD0cOKe3IufFQsYRevc9Xg5C9Ti1M8oCrvpFvP3YizC1L0e0bBa5VU',
    ];
@endphp
...
<div id="fab-box"
    ...
    <a href="{{ $links['max'] }}"
        class="fab-btn pointer-events-auto inline-flex items-center justify-center rounded-full border bg-white shadow p-3 hover:shadow-md"
        target="_blank" rel="noopener" aria-label="MAX">
